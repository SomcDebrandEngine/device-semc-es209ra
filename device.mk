...
PRODUCT_COPY_FILES += \
    device/semc/es209ra/prebuilt/system/etc/wifi/dnsmasq.conf:system/etc/wifi/dnsmasq.conf \
    device/semc/es209ra/prebuilt/system/etc/wifi/wpa_supplicant.conf:system/etc/wifi/wpa_supplicant.conf \
    device/semc/es209ra/prebuilt/system/etc/media_profiles.xml:system/etc/media_profiles.xml \
    device/semc/es209ra/prebuilt/system/etc/media_codecs.xml:system/etc/media_codecs.xml \
    device/semc/es209ra/prebuilt/system/etc/audio_policy.conf:system/etc/audio_policy.conf
#    device/semc/es209ra/prebuilt/system/etc/sensors.conf:system/etc/sensors.conf
...
PRODUCT_COPY_FILES += \
    device/semc/es209ra/prebuilt/system/etc/init.d/10dnsconf:system/etc/init.d/10dnsconf \
    device/semc/es209ra/prebuilt/system/etc/init.d/10regcode:system/etc/init.d/10regcode \
    device/semc/es209ra/prebuilt/system/etc/init.d/10hostapconf:system/etc/init.d/10hostapconf \
	device/semc/es209ra/prebuilt/system/etc/wifi/hostapd.conf:system/etc/wifi/hostapd.conf \
    device/semc/es209ra/prebuilt/system/etc/wifi/reg_code:system/etc/wifi/reg_code 
#\
